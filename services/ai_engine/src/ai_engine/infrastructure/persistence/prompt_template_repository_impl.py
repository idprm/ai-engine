...
from ai_engine.domain.repositories import PromptTemplateRepository
from ai_engine.infrastructure.persistence.database import get_db_session
from ai_engine.infrastructure.persistence.models import PromptTemplateModel
