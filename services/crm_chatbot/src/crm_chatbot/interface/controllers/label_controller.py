...
from crm_chatbot.application.services import LabelService
from crm_chatbot.domain.repositories import LabelRepository, ConversationLabelRepository
from crm_chatbot.infrastructure.persistence import LabelRepositoryImpl, ConversationLabelRepositoryImpl
