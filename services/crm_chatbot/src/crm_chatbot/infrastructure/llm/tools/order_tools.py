...
async def execute_create_order(
    ...
    from crm_chatbot.domain.entities import Order
    from crm_chatbot.domain.value_objects import TenantId, CustomerId
...
async def execute_add_to_order(
    ...
    from crm_chatbot.domain.entities import OrderItem
    from crm_chatbot.domain.value_objects import TenantId, CustomerId, ProductId
...
async def execute_get_order_status(
    ...
    from crm_chatbot.domain.value_objects import OrderId
...
async def execute_get_customer_orders(
    ...
    from crm_chatbot.domain.value_objects import CustomerId, OrderStatus
