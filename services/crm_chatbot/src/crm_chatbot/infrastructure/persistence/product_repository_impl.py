...
from crm_chatbot.domain.entities import Product, ProductVariant
from crm_chatbot.domain.repositories import ProductRepository
from crm_chatbot.domain.value_objects import ProductId, TenantId, Money
from crm_chatbot.infrastructure.persistence.database import get_db_session
from crm_chatbot.infrastructure.persistence.models import ProductModel, ProductVariantModel
