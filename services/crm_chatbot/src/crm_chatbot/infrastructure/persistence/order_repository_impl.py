...
from crm_chatbot.domain.entities import Order, OrderItem
from crm_chatbot.domain.repositories import OrderRepository
...
from crm_chatbot.infrastructure.persistence.models import OrderModel, OrderItemModel
