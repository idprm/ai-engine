...
from crm_chatbot.domain.entities import Ticket, TicketBoard, TicketTemplate
from crm_chatbot.domain.value_objects import TicketId, TenantId, TicketStatus, TicketPriority
